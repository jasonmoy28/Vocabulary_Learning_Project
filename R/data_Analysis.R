...
LenientScoreRawData = read.csv('https://raw.githubusercontent.com/jasonmoy28/Vocabulary_Learning_Project/master/R/Code/LenientScoringMaster.csv') %>% rename(Subject = 1)
